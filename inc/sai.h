...
#define SAI_RX_DMA_BUF_SIZE 20480 // 必须是160的倍数

extern u16 sairecbuf1[SAI_RX_DMA_BUF_SIZE];
extern u16 sairecbuf2[SAI_RX_DMA_BUF_SIZE];
extern u8 sairecbuf_curvalid;
